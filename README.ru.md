...
В настоящее время находится в бета-версии с отличным покрытием тестов и
комплексными языковыми возможностями.
...
- **100% Успех примеров** - Все 39 примеров компилируются и выполняются без
  ошибок
- **98% Покрытие тестов** - Комплексный набор тестов с 326+ тестовыми случаями
- **Ноль ошибок линтинга** - Поддерживаемая кодовая база по отраслевым
  стандартам
- **Современная архитектура** - Построена с использованием паттернов чистой
  архитектуры
...
SomonScript работает под проприетарной лицензией и не принимает прямые вклады в
код, но вы можете:
...
SomonScript является проприетарным программным обеспечением LindenTech IT
Consulting. Использование разрешено для личных, образовательных и коммерческих
целей в рамках условий лицензионного соглашения.
