...
// TODO(windows-ci): module-resolver normalises paths with POSIX separators; the
// assertions here compare against absolute paths that use '\' on Windows.
(process.platform === 'win32' ? describe.skip : describe)(
  'CLI Run Command - Module Imports',
  () => {
    let tempDir: string;
    let cliPath: string;
