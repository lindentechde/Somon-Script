...
export enum TokenType {
  ...
  ҚАЙД = 'ҚАЙД', // count
  ҚАЙД_АСЛ = 'ҚАЙД_АСЛ', // countReset
  ВАҚТ = 'ВАҚТ', // time
  ВАҚТ_САБТ = 'ВАҚТ_САБТ', // timeLog
  ВАҚТ_ОХИР = 'ВАҚТ_ОХИР', // timeEnd
  ҶАДВАЛ = 'ҶАДВАЛ', // table
  ФЕҲРИСТ = 'ФЕҲРИСТ', // dir
  XML_ФЕҲРИСТ = 'XML_ФЕҲРИСТ', // dirxml
  ПАЙҶО = 'ПАЙҶО', // trace
  ПОЛИЗ = 'ПОЛИЗ', // clear
  ГУРУҲ = 'ГУРУҲ', // group
  ГУРУҲ_ОХИР = 'ГУРУҲ_ОХИР', // groupEnd
  ГУРУҲ_ПӮШИДА = 'ГУРУҲ_ПӮШИДА', // groupCollapsed
